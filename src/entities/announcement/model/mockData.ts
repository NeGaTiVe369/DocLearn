    ...
    speakers: [
      {
        ...
        bio: "Head of AI Research at Stanford Medical School",
        status: "confirmed",
      },
    ],
    program: "AI in Healthcare, Telemedicine Trends, Digital Biomarkers",
    registrationRequired: true,
...
export const mockMasterClasses: (MasterClass & { id: string })[] = [
  ...
  },
  {
    ...
    description:
      "Практический мастер-класс по созданию кроссплатформенных мобильных приложений. Создадим полноценное приложение с нуля за два дня.",
    organizer: "IT Academy Pro",
    ...
    contactInfo: {
      email: "courses@itacademypro.ru",
      website: "https://itacademypro.ru",
    },
    tags: ["React Native", "мобильная разработка", "JavaScript", "программирование"],
    viewsCount: 189,
    isPromoted: false,
    ...
    instructor: {
      userId: "instructor-2",
      name: "Senior Developer Николаев М.А.",
      bio: "Ведущий мобильный разработчик с опытом 8+ лет",
      credentials: ["Senior React Native Developer", "Автор курсов по мобильной разработке"],
    },
    skillLevel: "intermediate",
    maxParticipants: 16,
    ...
    price: 25000,
    currency: "RUB",
    materials: ["Ноутбук с установленной средой разработки", "Исходный код проектов"],
    equipment: ["Проектор", "Флипчарт", "Wi-Fi"],
    duration: 16,
    categories: ["it"],
    prerequisites: "Знание JavaScript, опыт работы с React",
    certificates: true,
    handsOn: true,
    groupWork: false,
  },
