...
// export function SpeakersSection({ speakers, onUpdate, title = "Спикеры" }: SpeakersSectionProps) {
//   const [newSpeaker, setNewSpeaker] = useState({ name: "", eventRole: "", bio: "", photo: "" })
//   const [errors, setErrors] = useState<{ name?: string; eventRole?: string }>({})
...
//     if (!newSpeaker.eventRole.trim()) newErrors.eventRole = "Должность обязательна"
...
//         <FormField label="Должность" error={errors.eventRole}>
//           <input
//             type="text"
