...
export const NewEducationBlock: React.FC<NewEducationBlockProps> = ({
  education = [],
  onChange,
  onValidationChange,
  role = "student",
            ...
            <div key={edu.id || index} className={styles.educationItem}>
              ...
              <div className={styles.educationFields}>
                ...
                <div className={styles.formRow}>
                  <Form.Group>
                    ...
                    <Form.Control
                      ...
                      placeholder={isStudent ? "Специалитет" : "Специалитет, Ординатура, Аспирантура"}
                      readOnly={isStudent}
                      style={isStudent ? { backgroundColor: "#f8f9fa", cursor: "not-allowed" } : {}}
                    />
                ...
                <div className={styles.formRow}>
                  ...
                  <Form.Group>
                    <Form.Label className={styles.label}>Год окончания</Form.Label>
                    <Form.Control
                      type="number"
                      min="1950"
                      max={currentYear}
